...
public class Product {
    ...
    public Product(String title, String image, float walmart_price, float walmart_rating,
                   float walmart_rating_no, String walmart_link, float flipkart_price,
    ...
    public float getWalmart_price() {
        return walmart_price;
    }

    public void setWalmart_price(float walmart_price) {
        this.walmart_price = walmart_price;
    }
    ...
    public float getFlipkart_price() {
        return flipkart_price;
    }

    public void setFlipkart_price(float flipkart_price) {
        this.flipkart_price = flipkart_price;
    }
